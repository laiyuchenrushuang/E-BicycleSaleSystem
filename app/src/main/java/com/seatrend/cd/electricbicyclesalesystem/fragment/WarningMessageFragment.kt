...
import com.seatrend.cd.electricbicyclesalesystem.adpater.WarningMessageAdapter
...
class WarningMessageFragment : BaseFragment() , WarningMessageView {
    ...
    override fun netWorkTaskSuccess(commonResponse: CommonResponse) {
        ...
        try {
            if (commonResponse.getUrl().equals(Constants.WARNING_MESSAGE)){
                ...
                CollectBicycleActivity.mCarMessageEntity =GsonUtils.gson(commonResponse.getResponseString(), CarMessageEntity::class.java)
                val mIntent=Intent(context, CollectBicycleActivity::class.java)
    ...
    private fun getData(isShowDialog: Boolean){
     ...
     fun queryCarMessage(zcbm: String){
        ...
        mWarningMessagePersenter!!.doNetworkTask(map,Constants.GET_CAR_MSG)
    }
